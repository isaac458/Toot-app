...
public final class GroqRequest {
    ...
    @org.jetbrains.annotations.NotNull()
    private final java.util.List<com.empire.myapplication.data.remote.GroqMessage> messages = null;
    ...
    java.util.List<com.empire.myapplication.data.remote.GroqMessage> messages, float temperature, int maxTokens) {
        super();
    }
    ...
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.empire.myapplication.data.remote.GroqMessage> getMessages() {
        return null;
    }
    ...
    @org.jetbrains.annotations.NotNull()
    public final java.util.List<com.empire.myapplication.data.remote.GroqMessage> component2() {
        return null;
    }
    ...
    @org.jetbrains.annotations.NotNull()
    public final com.empire.myapplication.data.remote.GroqRequest copy(@org.jetbrains.annotations.NotNull()
    java.lang.String model, @org.jetbrains.annotations.NotNull()
    java.util.List<com.empire.myapplication.data.remote.GroqMessage> messages, float temperature, int maxTokens) {
        return null;
    }
